...
We first construct a directed DFS tree. Now for each non root node say u, if its child say v has no back edge to the ancestor nodes of u (i.e parents of node u). Then node u is an articulation point.  
<figure>
